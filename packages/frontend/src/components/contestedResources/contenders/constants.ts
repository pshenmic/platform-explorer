...
export type VoteEnumValue = (typeof VoteEnum)[keyof typeof VoteEnum]

export const API_VOTE_ENUM: VoteEnumValue[] = [
  VoteEnum.TO_APPROVE,
  VoteEnum.TO_ABSTAIN,
  VoteEnum.TO_REJECT
]
...
export const VOTING_CAPABLE_TYPES = ['voting'] as const

export type VotingCapableType = (typeof VOTING_CAPABLE_TYPES)[number]

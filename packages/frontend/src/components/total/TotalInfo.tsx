    ...
    >
      <Flex className={'TotalInfo__ContentContainer'} justify={'space-between'} wrap={'wrap'}>
        <Link
          href={'/blocks/'}
          className={
            'InfoBlock InfoBlock--NoBorder TotalInfo__Item TotalInfoItem TotalInfoItem--Blocks TotalInfoItem--Clikable'
          }
        >
        ...
        <Link
          href={'/transactions/'}
          className={
            'InfoBlock InfoBlock--NoBorder TotalInfo__Item TotalInfoItem TotalInfoItem--Transactions TotalInfoItem--Clikable'
          }
        >
          <div className={`TotalInfoItem__Value ${loading ? 'TotalInfoItem__Value--Loading' : ''}`}>
            {`${transactions || '-'}`}
        ...
        <Link
          href={'/dataContracts/'}
          className={
            'InfoBlock InfoBlock--NoBorder TotalInfo__Item TotalInfoItem TotalInfoItem--DataContracts TotalInfoItem--Clikable'
          }
        >
          <div className={`TotalInfoItem__Value ${loading ? 'TotalInfoItem__Value--Loading' : ''}`}>
            {`${dataContracts || '-'}`}
        ...
        <div
          className={
            'InfoBlock InfoBlock--NoBorder TotalInfo__Item TotalInfoItem TotalInfoItem--Documents'
          }
        >
          <div className={`TotalInfoItem__Value ${loading ? 'TotalInfoItem__Value--Loading' : ''}`}>
            {`${documents || '-'}`}
        ...
        <Link
          href={'/identities/'}
          className={
            'InfoBlock InfoBlock--NoBorder TotalInfo__Item TotalInfoItem TotalInfoItem--Identities TotalInfoItem--Clikable'
          }
        >
          <div className={`TotalInfoItem__Value ${loading ? 'TotalInfoItem__Value--Loading' : ''}`}>
            {`${identities || '-'}`}

...
export default function ActivityListItem({ activity, decimals }: ActivityListItemProps) {
  ...
  return (
    <Link href={`/transaction/${activity?.stateTransitionHash}`} className={'ActivityListItem'}>
      <div className={'ActivityListItem__Content'}>
        <div className={'ActivityListItem__Column ActivityListItem__Column--Timestamp'}>
          {activity?.status && (
            <Tooltip title={activity?.status} content={activity?.error || ''} placement={'top'}>
              <span>
                <StatusIcon
        ...
        <div
          className={
            'ActivityListItem__Column ActivityListItem__Column--Amount ActivityListItem__Column--Number'
          }
        >

...
function PlatformAddressTotalCard({ address, rate }: PlatformAddressTotalCardProps) {
  return (
    <div
      className={`InfoBlock InfoBlock--Gradient PlatformAddressTotalCard ${address.isLoading ? 'PlatformAddressTotalCard--Loading' : ''}`}
    >
        ...
        <div className={'PlatformAddressTotalCard__Column'}>
          <div className={'PlatformAddressTotalCard__Header'}>
            <div className={'PlatformAddressTotalCard__HeaderLines'}>
              <InfoLine
                className={
                  'PlatformAddressTotalCard__InfoLine PlatformAddressTotalCard__InfoLine--Address'
                }
              ...
              <InfoLine
                className={
                  'PlatformAddressTotalCard__InfoLine PlatformAddressTotalCard__InfoLine--Balance'
                }
                title={'Balance'}
          ...
          <div className={'PlatformAddressTotalCard__CommonLines'}>
            ...
            <InfoLine
              ...
              loading={address.isLoading}
              error={
                address.isError || (!address.isLoading && address.data?.totalTxs === undefined)
              }
            />
            <InfoLine
              className={'PlatformAddressTotalCard__InfoLine'}
              ...
              loading={address.isLoading}
              error={
                address.isError || (!address.isLoading && address.data?.incomingTxs === undefined)
              }
            />
            <InfoLine
              className={'PlatformAddressTotalCard__InfoLine'}
              ...
              loading={address.isLoading}
              error={
                address.isError || (!address.isLoading && address.data?.outgoingTxs === undefined)
              }
            />
          </div>
        </div>

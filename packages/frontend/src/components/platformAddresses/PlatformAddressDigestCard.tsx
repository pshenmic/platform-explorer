...
function PlatformAddressDigestCard({ address, rate, className }: PlatformAddressDigestCardProps) {
  return (
    <div
      className={`PlatformAddressDigestCard ${className || ''} ${address.isLoading ? 'PlatformAddressDigestCard--Loading' : ''}`}
    >
      <div className={'PlatformAddressDigestCard__Transfers'}>
        <div
          className={
            'PlatformAddressDigestCard__Transfer PlatformAddressDigestCard__Transfer--Incoming'
          }
        >
        ...
        <div
          className={
            'PlatformAddressDigestCard__Transfer PlatformAddressDigestCard__Transfer--Outgoing'
          }
        >

...
function NetworkStatus ({ className }: WithClassName) {
  ...
  return (
    <div className={`NetworkStatus  ${className || ''}`}>
      <div className={`NetworkStatus__Stat NetworkStatus__Stat--Epoch ${status?.loading ? 'NetworkStatus__Stat--Loading' : ''}`}>
      ...
      <div className={`NetworkStatus__Stat NetworkStatus__Stat--PlatformVersion ${status?.loading ? 'NetworkStatus__Stat--Loading' : ''}`}>
        ...
        <div className={'NetworkStatus__InfoValue'}>{status?.data?.versions?.software?.drive !== undefined && status?.data?.versions?.software?.drive !== null ? `v${status?.data?.versions?.software?.drive}` : '-'}</div>
      </div>
      ...
      <div className={`NetworkStatus__Stat NetworkStatus__Stat--Network ${status?.loading ? 'NetworkStatus__Stat--Loading' : ''}`}>
      ...
      <div className={`NetworkStatus__Stat NetworkStatus__Stat--Api ${status?.loading ? 'NetworkStatus__Stat--Loading' : ''}`}>
      ...
      <div className={`NetworkStatus__Stat NetworkStatus__Stat--LatestBlock ${status?.loading ? 'NetworkStatus__Stat--Loading' : ''}`}>
        <div className={'NetworkStatus__InfoTitle'}>Latest block:</div>
        <div className={'NetworkStatus__InfoValue'}>
          <Badge colorScheme={'gray'} className={'NetworkStatus__Badge'}>
            {status?.data?.api?.block?.height !== undefined && status?.data?.api?.block?.height !== null

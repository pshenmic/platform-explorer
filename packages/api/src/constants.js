...
module.exports = {
  WITHDRAWAL_CONTRACT: process.env.WITHDRAWAL_CONTRACT ?? '4fJLR2GYTPFdomuTVvNy3VRrvWgvkKPzqehEBpNf2nk6',
  WITHDRAWAL_CONTRACT_TYPE: process.env.WITHDRAWAL_CONTRACT_TYPE ?? 'withdrawal',

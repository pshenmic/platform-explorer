...
impl PostgresDAO {
  pub async fn create_masternode_vote(&self, masternode_vote: MasternodeVote, st_hash: String, sql_transaction: &Transaction<'_>) -> Result<(), PoolError> {
    ...
    let data_contract = self
      .get_data_contract_by_identifier(masternode_vote.data_contract_identifier, sql_transaction)
    ...
    let stmt = sql_transaction.prepare_cached("INSERT INTO masternode_votes(pro_tx_hash, \

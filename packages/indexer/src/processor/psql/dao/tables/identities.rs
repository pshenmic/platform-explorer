...
impl PostgresDAO {
  pub async fn create_identity(&self, identity: Identity, st_hash: Option<String>, sql_transaction: &Transaction<'_>) -> Result<(), PoolError> {
  ...
  pub async fn create_identity_alias(&self, identity: Identity, alias: String, st_hash: String, sql_transaction: &Transaction<'_>) -> Result<(), PoolError> {
